...
**
** Created: Mon 4. May 17:10:25 2009
...
static const char qt_meta_stringdata_PortListener[] = {
    "PortListener\0\0receive()\0bytes\0"
    "reportWritten(qint64)\0reportClose()\0"
    "status\0reportDsr(bool)\0"
};
...
int PortListener::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: receive(); break;
        case 1: reportWritten((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 2: reportClose(); break;
        case 3: reportDsr((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
